...
const String kHeaderSlide1 = 'assets/imgs/img5.jpg';
...
final double kImgHeight = getHeight(550.0);
...
const String onBoardingTitle1 = "Explorez un univers de cantiques";
const String onBoardingTitle2 = "Créez votre collection de favoris";
const String onBoardingTitle3 = "Localisez nos lieux de culte";
const String onBoardingTitle4 = "Maîtrisez vos cantiques avec aisance";

const String onBoardingSubTitle1 =
    "Plongez dans une vaste bibliothèque de plus de 1400 cantiques de Sion, soigneusement sélectionnés pour nourrir votre âme.";
const String onBoardingSubTitle2 =
    "Ne perdez plus jamais vos chants préférés. Enregistrez vos cantiques favoris pour un accès rapide et simplifié.";
const String onBoardingSubTitle3 =
    "Trouvez facilement les adresses de nos églises et rapprochez-vous davantage de la communauté.";
const String onBoardingSubTitle4 =
    "Apprenez à chanter vos cantiques préférés grâce aux instrumentales disponibles pour vous guider pas à pas.";
const String kHome = 'Accueil';
const String lizandu = "Soleil Couchant Tabernacle";
